...
import StatementUnit from "../components/SpecUnit";
  ...
  return (
    <div class="big_div">
      <div class="main_content" style={{display:"flex"}}>
        <div class="content" style={{background:"white", width:"30%", display:"block"}}>
        <SpecBar></SpecBar>
      <div style={{marginTop:"40px"}}>
        <StatementUnit 
          name={"Эксплуатация и ремонт самолетов, вертолетов и авиационных двигателей"}
          cypher={"461000"}
          type={"Программа подготовки офицеров запаса"}
        ></StatementUnit>
      ...
      <div class="content" style={{background:"white", width:"70%"}}>
